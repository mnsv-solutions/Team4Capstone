...
async function seedBase() {
  ...
  type CibilEnquirySeed = {
    enquiry_date: Date;
    institution: string;
    enquiry_type: string;
  };

  type CibilRiskIndicatorsSeed = {
  ...
  type CibilProfileSeed = {
    ...
    applicant: CibilApplicantSeed;
    accounts: CibilAccountSeed[];
    paymentHistoryStatuses: string[];
    enquiries: CibilEnquirySeed[];
    riskIndicators: CibilRiskIndicatorsSeed;
  };

  type CibilSeedRecord = CibilProfileSeed & {
    request_id: string;
    reference_id: string;
    status: string;
    score_band: string;
  ...
  function buildCibilScoreBand(score: number): string {
  ...
  function buildCibilRiskLevel(score: number): string {
  ...
  function buildCibilRequestId(sequence: number): string {
    return `REQ-20260323-${String(sequence).padStart(3, '0')}`;
  }

  function buildCibilReferenceId(sequence: number): string {
    return `CIBIL-${789456122 + sequence}`;
  }
  function getLast4Digits(value: string): string {
    const digitsOnly = value.replace(/\D/g, '');

    if (digitsOnly.length < 4) {
      throw new Error(`SIN value must contain at least 4 digits. Received: ${value}`);
    }
  ...
  function applicant(
    ...
    return {
      ...
      last_name,
      date_of_birth: new Date(dob),
      sin_number: getLast4Digits(sin_number),
      mobile_number,
    };
  }
  ...
  function risk(
    ...
    thin_file: boolean,
    credit_mix_healthy: boolean,
  ): CibilRiskIndicatorsSeed {
    return {
      high_credit_utilization,
      recent_hard_enquiries,
      thin_file,
      credit_mix_healthy,
    };
  }

  function history(...statuses: string[]): string[] {
    return statuses;
  }

  function createCibilSeedRecord(sequence: number, profile: CibilProfileSeed): CibilSeedRecord {
    return {
      request_id: buildCibilRequestId(sequence),
      reference_id: buildCibilReferenceId(sequence),
      status: 'SUCCESS',
      score_band: buildCibilScoreBand(profile.cibil_score),
      risk_level: buildCibilRiskLevel(profile.cibil_score),
      score_version: 'CIBIL 2.0',
      ...profile,
    };
  }

  const cibilProfiles: CibilProfileSeed[] = [
    {
      ...
      active_accounts: 3,
      closed_accounts: 2,
      total_outstanding_balance: '145000.00',
      secured_loan_accounts: 2,
      unsecured_loan_accounts: 3,
      total_missed_payments: 0,
      recent_delinquency: false,
      credit_utilization_ratio: '0.12',
      average_account_age_years: '4.60',
      debt_to_income_estimate: '0.23',
      applicant: applicant('Nirali', 'Patel', '2000-05-12', 'ABCDE1234F', '9876543210'),
      accounts: [
        account(
          'PERSONAL_LOAN',
          'HDFC Bank',
      ...
      paymentHistoryStatuses: history(
        '000',
        '000',
        '000',
        '000',
      ...
      enquiries: [
        enquiry('2026-02-10', 'Axis Bank', 'LOAN_ENQUIRY'),
        enquiry('2025-12-05', 'SBI', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(false, false, false, true),
    },
    {
      ...
      active_accounts: 2,
      closed_accounts: 2,
      total_outstanding_balance: '85000.00',
      secured_loan_accounts: 1,
      unsecured_loan_accounts: 3,
      total_missed_payments: 0,
      recent_delinquency: false,
      credit_utilization_ratio: '0.08',
      average_account_age_years: '5.20',
      debt_to_income_estimate: '0.19',
      applicant: applicant('Sukhpreet', 'Singh', '1998-09-21', 'BCDEF2345G', '9876543211'),
      accounts: [
        account('AUTO_LOAN', 'SBI', 'XXXXXX1111', '2022-04-11', '42000.00', null, 'CURRENT', 0),
        account(
          'CREDIT_CARD',
          'Axis Bank',
          'XXXXXX1112',
      ...
      enquiries: [
        enquiry('2026-01-15', 'HDFC Bank', 'AUTO_LOAN_ENQUIRY'),
        enquiry('2025-11-28', 'ICICI Bank', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(false, false, false, true),
    },
    {
      ...
      active_accounts: 4,
      closed_accounts: 2,
      total_outstanding_balance: '165000.00',
      ...
      debt_to_income_estimate: '0.27',
      applicant: applicant('Victor', 'Dsouza', '1995-11-03', 'CDEFG3456H', '9876543212'),
      accounts: [
        account(
          'HOME_LOAN',
          'LIC Housing',
      ...
      enquiries: [
        enquiry('2026-02-20', 'Kotak Mahindra Bank', 'HOME_LOAN_ENQUIRY'),
        enquiry('2025-10-14', 'Axis Bank', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(false, true, false, true),
    },
    {
      ...
      active_accounts: 5,
      closed_accounts: 2,
      total_outstanding_balance: '178000.00',
      secured_loan_accounts: 4,
      unsecured_loan_accounts: 3,
      total_missed_payments: 0,
      recent_delinquency: false,
      credit_utilization_ratio: '0.10',
      average_account_age_years: '5.90',
      debt_to_income_estimate: '0.20',
      applicant: applicant('Miswa', 'Ahmed', '1997-02-18', 'DEFGH4567I', '9876543213'),
      accounts: [
        account(
          'PERSONAL_LOAN',
          'Kotak Mahindra Bank',
      ...
      enquiries: [
        enquiry('2026-03-01', 'RBL Bank', 'PERSONAL_LOAN_ENQUIRY'),
        enquiry('2026-01-09', 'Yes Bank', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(false, true, false, true),
    },
    {
      ...
      active_accounts: 1,
      closed_accounts: 2,
      total_outstanding_balance: '42000.00',
      secured_loan_accounts: 1,
      ...
      applicant: applicant('Aarav', 'Sharma', '1999-07-07', 'EFGHI5678J', '9876543214'),
      accounts: [
        account(
          'EDUCATION_LOAN',
          'Bank of Baroda',
      ...
      enquiries: [
        enquiry('2025-12-11', 'Bank of Baroda', 'EDUCATION_LOAN_ENQUIRY'),
        enquiry('2025-09-07', 'American Express', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(false, false, false, true),
    },
    {
      ...
      applicant: applicant('Priya', 'Mehta', '1996-04-25', 'FGHIJ6789K', '9876543215'),
      accounts: [
        account(
          'PERSONAL_LOAN',
          'IndusInd Bank',
      ...
      enquiries: [
        enquiry('2026-02-12', 'IndusInd Bank', 'PERSONAL_LOAN_ENQUIRY'),
        enquiry('2025-12-29', 'ICICI Bank', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(false, true, false, true),
    },
    {
      ...
      active_accounts: 2,
      closed_accounts: 2,
      total_outstanding_balance: '118000.00',
      secured_loan_accounts: 1,
      unsecured_loan_accounts: 3,
      total_missed_payments: 1,
      recent_delinquency: false,
      ...
      average_account_age_years: '4.10',
      debt_to_income_estimate: '0.29',
      applicant: applicant('Ananya', 'Iyer', '2001-01-30', 'HIJKL8901M', '9876543217'),
      accounts: [
        account(
          'AUTO_LOAN',
          'Canara Bank',
      ...
      enquiries: [
        enquiry('2025-11-19', 'Canara Bank', 'AUTO_LOAN_ENQUIRY'),
        enquiry('2025-08-23', 'HDFC Bank', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(false, false, false, true),
    },
    {
      ...
      applicant: applicant('Karan', 'Malhotra', '1993-06-11', 'IJKLM9012N', '9876543218'),
      accounts: [
        account(
          'HOME_LOAN',
          'PNB Housing',
      ...
      enquiries: [
        enquiry('2026-01-17', 'PNB Housing', 'HOME_LOAN_ENQUIRY'),
        enquiry('2025-11-01', 'SBI Card', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(true, true, false, true),
    },
    {
      ...
      active_accounts: 3,
      closed_accounts: 2,
      total_outstanding_balance: '238000.00',
      secured_loan_accounts: 2,
      unsecured_loan_accounts: 3,
      total_missed_payments: 2,
      ...
      debt_to_income_estimate: '0.42',
      applicant: applicant('Diya', 'Kapoor', '1998-08-09', 'JKLMN0123P', '9876543219'),
      accounts: [
        account(
          'CREDIT_CARD',
          'ICICI Bank',
      ...
      enquiries: [
        enquiry('2025-10-08', 'ICICI Bank', 'CREDIT_CARD_ENQUIRY'),
        enquiry('2025-07-12', 'HDFC Bank', 'AUTO_LOAN_ENQUIRY'),
      ],
      riskIndicators: risk(false, true, false, true),
    },
    {
      ...
      active_accounts: 2,
      closed_accounts: 1,
      total_outstanding_balance: '98000.00',
      secured_loan_accounts: 1,
      unsecured_loan_accounts: 2,
      total_missed_payments: 1,
      recent_delinquency: false,
      credit_utilization_ratio: '0.24',
      average_account_age_years: '3.80',
      debt_to_income_estimate: '0.33',
      applicant: applicant('Rhea', 'Bhatia', '1997-10-14', 'KLMNO1123Q', '9876543220'),
      accounts: [
        account(
          'PERSONAL_LOAN',
          'Axis Bank',
      ...
      enquiries: [
        enquiry('2026-02-22', 'Axis Bank', 'PERSONAL_LOAN_ENQUIRY'),
        enquiry('2025-10-17', 'Kotak Bank', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(false, true, false, true),
    },
    {
      report_date: new Date('2026-03-13T11:05:00Z'),
      cibil_score: 674,
      total_accounts: 7,
      active_accounts: 5,
      closed_accounts: 2,
      total_outstanding_balance: '296000.00',
      secured_loan_accounts: 4,
      unsecured_loan_accounts: 3,
      total_missed_payments: 3,
      recent_delinquency: true,
      credit_utilization_ratio: '0.46',
      average_account_age_years: '2.30',
      debt_to_income_estimate: '0.49',
      applicant: applicant('Arjun', 'Sethi', '1994-03-16', 'LMNOP2234R', '9876543221'),
      accounts: [
        account(
          'BUSINESS_LOAN',
          'Yes Bank',
      ...
      enquiries: [
        enquiry('2026-02-05', 'Yes Bank', 'BUSINESS_LOAN_ENQUIRY'),
        enquiry('2025-12-13', 'RBL Bank', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(true, true, false, true),
    },
    {
      report_date: new Date('2026-03-12T10:25:00Z'),
      cibil_score: 632,
      total_accounts: 7,
      active_accounts: 5,
      closed_accounts: 2,
      total_outstanding_balance: '388000.00',
      secured_loan_accounts: 4,
      unsecured_loan_accounts: 3,
      total_missed_payments: 4,
      recent_delinquency: true,
      credit_utilization_ratio: '0.58',
      average_account_age_years: '1.90',
      debt_to_income_estimate: '0.56',
      applicant: applicant('Neha', 'Arora', '1996-07-18', 'MNOPQ3345S', '9876543222'),
      accounts: [
        account(
          'PERSONAL_LOAN',
          'Kotak Mahindra Bank',
      ...
      riskIndicators: risk(true, true, false, false),
    },
    {
      report_date: new Date('2026-03-11T14:50:00Z'),
      cibil_score: 608,
      total_accounts: 8,
      active_accounts: 6,
      closed_accounts: 2,
      total_outstanding_balance: '432000.00',
      secured_loan_accounts: 5,
      unsecured_loan_accounts: 3,
      total_missed_payments: 5,
      recent_delinquency: true,
      credit_utilization_ratio: '0.63',
      average_account_age_years: '1.60',
      debt_to_income_estimate: '0.61',
      applicant: applicant('Rohan', 'Gupta', '1994-12-14', 'NOPQR4456T', '9876543223'),
      accounts: [
        account(
          'BUSINESS_LOAN',
          'Yes Bank',
      ...
      enquiries: [
        enquiry('2026-03-05', 'Yes Bank', 'BUSINESS_LOAN_ENQUIRY'),
        enquiry('2026-02-02', 'Standard Chartered', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(true, true, true, false),
    },
    {
      report_date: new Date('2026-03-10T09:35:00Z'),
      cibil_score: 575,
      total_accounts: 8,
      active_accounts: 6,
      closed_accounts: 2,
      total_outstanding_balance: '510000.00',
      secured_loan_accounts: 5,
      unsecured_loan_accounts: 3,
      ...
      debt_to_income_estimate: '0.69',
      applicant: applicant('Pooja', 'Khanna', '1992-12-03', 'OPQRS5567U', '9876543224'),
      accounts: [
        account(
          'PERSONAL_LOAN',
          'Bajaj Finance',
      ...
      enquiries: [
        enquiry('2026-02-19', 'Bajaj Finance', 'PERSONAL_LOAN_ENQUIRY'),
        enquiry('2026-01-11', 'Axis Bank', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(true, true, true, false),
    },
    {
      report_date: new Date('2026-03-09T13:20:00Z'),
      cibil_score: 548,
      total_accounts: 9,
      active_accounts: 7,
      closed_accounts: 2,
      total_outstanding_balance: '598000.00',
      secured_loan_accounts: 6,
      unsecured_loan_accounts: 3,
      total_missed_payments: 7,
      recent_delinquency: true,
      credit_utilization_ratio: '0.84',
      average_account_age_years: '1.00',
      debt_to_income_estimate: '0.74',
      applicant: applicant('Kabir', 'Saxena', '1991-05-27', 'PQRST6678V', '9876543225'),
      accounts: [
        account(
          'BUSINESS_LOAN',
          'IndusInd Bank',
      ...
      enquiries: [
        enquiry('2026-03-07', 'IndusInd Bank', 'BUSINESS_LOAN_ENQUIRY'),
        enquiry('2026-02-14', 'SBI Card', 'CREDIT_CARD_ENQUIRY'),
      ],
      riskIndicators: risk(true, true, true, false),
    },
  ];

  const cibilSeedData = cibilProfiles.map((profile, index) =>
    createCibilSeedRecord(index + 1, profile),
  );
  const cibilApplicationTargets = additionalApplications.slice(0, 15);
